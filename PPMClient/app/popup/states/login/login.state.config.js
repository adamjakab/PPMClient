/**
 * When a user navigates to the 'home' route (/), this file will be consulted to determine whether its lazy dependencies
...
define
({
    routeDependencyId: 'states/login/login.dependencies',
    optimize: false,
    lazyDependencies: [
        'states/login/login.controller',
